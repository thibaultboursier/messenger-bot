...
// 3. ./ngrok http 8445
// 4. WIT_TOKEN=your_access_token FB_APP_SECRET_TOKEN=your_app_secret FB_PAGE_ACCESS_TOKEN=your_page_token node examples/messenger.js
...
function verifyRequestSignature(req, res, buf) {
    ...
    if (!signature) {
        ...
        var expectedHash = crypto.createHmac('sha1', FB_APP_SECRET_TOKEN)
            .update(buf)
            .digest('hex');
